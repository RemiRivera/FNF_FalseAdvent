...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'aorta':
				dialogue = CoolUtil.coolTextFile(Paths.txt('aorta/aortaDialogue'));
			case 'strain':
				dialogue = CoolUtil.coolTextFile(Paths.txt('strain/tendrilsDialogue'));
			case 'bloodsport':
				dialogue = CoolUtil.coolTextFile(Paths.txt('bloodsport/bloodsportDialogue'));
		}
		...
		switch(stageCheck)
		{
			...
			case 'atrium':
			{
						defaultCamZoom = 0.7;
						curStage = 'atrium';
						var bg:FlxSprite = new FlxSprite(-1800, -1000).loadGraphic(Paths.image('atrium/atrium'));
						bg.antialiasing = true;
			...
			case 'atriumGlow':
			{
						defaultCamZoom = 0.4;
						curStage = 'atriumGlow';
						var bg:FlxSprite = new FlxSprite(-1800, -1000).loadGraphic(Paths.image('atriumGlow/atriumGlow'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
